...
/**
 * Runs Right CommandGroup during autonomous, this command exists
 ...
 * @author Robotics
 */
public class RunRight extends Command {

    public RunRight() { }

    // Called just before this Command runs the first time
    @Override
	protected void initialize() { Scheduler.getInstance().add(new Right());}
