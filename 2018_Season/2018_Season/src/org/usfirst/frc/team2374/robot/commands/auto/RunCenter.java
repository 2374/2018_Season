...
/**
 * Runs Center CommandGroup during autonomous, this command exists
 ...
 * @author Robotics
 */
public class RunCenter extends Command {

    public RunCenter() { }

    // Called just before this Command runs the first time
    @Override
	protected void initialize() { Scheduler.getInstance().add(new Center()); }
